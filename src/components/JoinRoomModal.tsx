				...
				<div className="p-6">
					<div className="flex items-center justify-between mb-6">
						...
						<button
							...
							className="text-[var(--color-app-text-muted)] hover:text-[var(--color-app-text)] transition-colors">
							<X className="w-5 h-5" />
						</button>
					</div>

					<p className="text-sm text-[var(--color-app-text-muted)] mb-6">
						Enter the 6-character room code shared by the creator to join their
						custom match.
					</p>
					...
					<form onSubmit={handleSubmit} className="flex flex-col gap-4">
						<div className="relative">
							<input
								...
								className={cn(
									"w-full bg-[var(--color-app-bg)]/60 border h-14 rounded-xl px-4 text-center text-2xl font-mono font-bold tracking-[0.5em] text-[var(--color-app-text)] outline-none transition-all placeholder:text-[var(--color-app-text-muted)] placeholder:tracking-normal",
									error ?
