            ...
            <div className="flex flex-col items-center gap-6 relative z-10">
              ...
              <div className="text-center">
                ...
                <button 
                  ...
                  className="text-[var(--color-app-text-muted)] text-[10px] uppercase font-black tracking-widest bg-white/5 py-1 px-3 rounded-full border border-white/5 hover:bg-white/10 transition-colors flex items-center gap-2 mx-auto"
                >
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  ...
                  <div className="bg-[var(--color-app-hover)]/20 border border-[var(--color-app-border-light)] rounded-2xl p-5 flex flex-col gap-1">
                    ...
                    <div className="text-2xl font-black text-white">{currentExp.toLocaleString()} <span className="text-xs text-[var(--color-app-text-muted)] font-bold">XP</span></div>
                  </div>
                </div>
              </div>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="bg-[var(--color-app-panel)] w-full max-w-4xl rounded-[2.5rem] border border-[var(--color-app-border-light)] shadow-2xl relative z-10 flex flex-col max-h-[85vh] animate-in zoom-in-95 duration-300 overflow-hidden">
            <div className="p-8 border-b border-[var(--color-app-border-light)] flex items-center justify-between">
              <div>
                <h2 className="text-2xl font-black text-white">Choose Avatar</h2>
                <p className="text-sm text-[var(--color-app-text-muted)]">Select a profile picture that represents you</p>
              </div>
              <button 
                onClick={() => setIsAvatarModalOpen(false)}
                className="w-10 h-10 rounded-xl bg-[var(--color-app-bg)] border border-[var(--color-app-border-light)] flex items-center justify-center text-[var(--color-app-text-muted)] hover:text-white transition-colors"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <div className="p-8 border-t border-[var(--color-app-border-light)] bg-white/5 flex flex-col sm:flex-row items-center justify-between gap-6">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
                {!user.isAnonymous && !tempAvatar && (
                  <button 
                    ...
                    className="w-full sm:w-auto flex items-center justify-center gap-2.5 px-6 py-3 rounded-2xl bg-white/5 border border-white/10 text-xs font-black uppercase tracking-widest text-white hover:bg-white/10 transition-all active:scale-95"
                  >
          ...
          <div className="bg-[var(--color-app-panel)] w-full max-w-md rounded-[2rem] border border-[var(--color-app-border-light)] shadow-2xl relative z-10 animate-in zoom-in-95 duration-300 overflow-hidden">
            <div className="p-6 border-b border-[var(--color-app-border-light)] flex items-center justify-between">
              ...
              <button 
                ...
                className="w-8 h-8 rounded-lg bg-[var(--color-app-bg)] border border-[var(--color-app-border-light)] flex items-center justify-center text-[var(--color-app-text-muted)] hover:text-white transition-colors"
              >
                <X className="w-4 h-4" />
              </button>
            </div>
            ...
            <div className="p-8 text-sm text-[var(--color-app-text-muted)] leading-relaxed space-y-4">
              {infoPopup === 'elo' ? (
                <>
                  <p>The <span className="text-white font-bold">ELO Rating system</span> measures your relative skill level compared to other players.</p>
                  <div className="bg-[var(--color-app-bg)] p-4 rounded-xl border border-white/5 space-y-2">
                ...
                <>
                  <p>Your <span className="text-white font-bold">Explorer Rank</span> is earned through experience (XP). Accumulate XP by playing matches, finding exact locations, and completing achievements.</p>
                  <div className="bg-[var(--color-app-bg)] p-4 rounded-xl border border-white/5 space-y-3">
                    <div>
                      <p className="text-white font-bold text-xs uppercase">Level 1-4: Rookie</p>
        ...
        <div className="fixed inset-0 z-[130] flex items-center justify-center p-4">
          ...
          <div className="bg-[var(--color-app-panel)] w-full max-w-md rounded-[2rem] border border-red-500/30 shadow-2xl relative z-10 animate-in zoom-in-95 duration-300 overflow-hidden">
            <div className="p-6 border-b border-red-500/20 flex items-center justify-between">
              ...
              <button onClick={() => setDeleteConfirmOpen(false)} className="w-8 h-8 rounded-lg bg-[var(--color-app-bg)] border border-[var(--color-app-border-light)] flex items-center justify-center text-[var(--color-app-text-muted)] hover:text-white transition-colors">
                <X className="w-4 h-4" />
              </button>
            </div>
            <div className="p-6 flex flex-col gap-4">
              <p className="text-sm text-[var(--color-app-text-muted)] leading-relaxed">
                This will permanently delete your account, profile, stats, and all associated data. <span className="text-white font-bold">This action cannot be undone.</span>
              </p>
              <div className="flex flex-col gap-2">
            ...
            <div className="p-6 bg-red-500/5 border-t border-red-500/20 flex items-center justify-end gap-3">
              <button onClick={() => setDeleteConfirmOpen(false)} className="px-5 py-2 rounded-xl text-sm font-bold text-[var(--color-app-text-muted)] hover:text-white transition-colors">
                Cancel
              </button>
              <button
