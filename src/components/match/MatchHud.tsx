    ...
    <>
      <div className="absolute top-5 left-5 right-5 z-20 pointer-events-none flex items-start justify-between gap-4">
        <div className="flex gap-4">
          <div className="pointer-events-auto rounded-2xl border border-[var(--color-app-border)] bg-[var(--color-app-panel)]/80 backdrop-blur-xl shadow-[0_18px_45px_rgba(0,0,0,0.35)] px-4 py-3 min-w-[210px]">
            ...
            <div className="mt-3 flex items-center justify-between gap-3">
              ...
              {selectedMode === "classic" ? (
                <div className="rounded-full border border-indigo-400/25 bg-indigo-400/10 px-3.5 py-1.5 text-[11px] font-bold text-indigo-200">
                  Solo: {totalScore.toLocaleString()}
                </div>
              ) : selectedMode === "creatorRoom" ? (
          ...
          <div className="pointer-events-auto h-fit rounded-xl border border-[var(--color-app-border)] bg-[var(--color-app-panel)]/80 flex items-center justify-center p-1 shadow-lg backdrop-blur-xl">
            <AudioSettingsControl align="left" />
          </div>
        </div>
